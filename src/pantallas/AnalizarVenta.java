...
public class AnalizarVenta {
	...
	private void initialize() {
		...
		frmFmMaderas.setBounds(100, 100, 468, 384);
		...
		frmFmMaderas.getContentPane().add(lblAnalizarVenta);
		...
		frmFmMaderas.getContentPane().add(lblFinPeriodo);
		...
		btnNewButton.setBounds(352, 135, 69, 23);
		frmFmMaderas.getContentPane().add(btnNewButton);
		...
		frmFmMaderas.getContentPane().add(lblDe);
		...
		frmFmMaderas.getContentPane().add(comboBox_1);
		
		JLabel label = new JLabel("de");
		label.setFont(new Font("Tahoma", Font.PLAIN, 16));
		label.setBounds(323, 182, 23, 20);
		frmFmMaderas.getContentPane().add(label);
		
		textField_1 = new JTextField();
		textField_1.setBounds(352, 182, 53, 20);
		frmFmMaderas.getContentPane().add(textField_1);
		...
		frmFmMaderas.getContentPane().add(comboBox_2);
		
		JLabel label_1 = new JLabel("de");
		label_1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		label_1.setBounds(194, 224, 23, 20);
		frmFmMaderas.getContentPane().add(label_1);
		...
		frmFmMaderas.getContentPane().add(comboBox_3);
		
		JLabel label_2 = new JLabel("de");
		label_2.setFont(new Font("Tahoma", Font.PLAIN, 16));
		label_2.setBounds(323, 224, 23, 20);
		frmFmMaderas.getContentPane().add(label_2);
		
		textField_2 = new JTextField();
		textField_2.setColumns(10);
		textField_2.setBounds(352, 224, 53, 20);
		frmFmMaderas.getContentPane().add(textField_2);
		...
		frmFmMaderas.getContentPane().add(btnAnalizar);
	}
}
